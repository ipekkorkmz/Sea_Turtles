...
```{r}
#df <-subset(data, select = -c(monitoring_effort, mds))
...
```{r}
#write.csv(yearly_data,"data\\yearly_data.csv", row.names = FALSE)
```
...
```{r}
#df_sf <- subset(data_sf, select = -c(monitoring_effort, mds))
#st_write(df_sf,"data\\data_sf.shp, row.names = FALSE)
```
